...
# -*- coding: utf-8 -*-
###############################################################################
from tkinter import Tk, Menu, Label, Frame, Canvas, RIGHT, messagebox, PhotoImage
from configurations import *
import controller, exceptions, preferenceswindow


class View():  # handles the forntend presentation
    ...
    def shift(self, start_pos, end_pos):
        ...
        if not piece_at_destination or piece_at_destination.color != selected_piece.color:
            try:
                ...
                self.info_label['text'] = error.__class__.__name__  # if a move will cause check on the king
            else:
...
#callbacks
    ...
    def on_about_menu_clicked(self):
        messagebox.showinfo("From the Book:", "Tkinter GUI Application\n Development Blueprints.")
