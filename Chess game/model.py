...
import piece, exceptions


class Model(dict):  # handles backend data and logic
    captured_pieces = {'white': [], 'black': []}
    player_turn = None
    halfmove_clock = 0  # track of the number of turns played since the last pawn advance or capture
    fullmove_number = 1  # incremented by 1 after every move of a black piece. track the overall length of a game
    history = []

    def __init__(self):
        self.reset_to_initial_locations()

    #getter & setter methtod
