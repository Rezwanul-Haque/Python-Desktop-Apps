...
##Constants End
root.title(PROGRAM_NAME)  # Application Name
...
save_as_file_icon = PhotoImage(file='icons/save_as.gif')
exit_icon = PhotoImage(file='icons/exit.gif')
...
def find_text(event=None):
    ...
    def close_search_window():
        ...
        search_toplvel.protocol('WM_DELETE_WINDOW', close_search_window)
        return 'break'
...
file_menu.add_command(label='Save as', accelerator='Shift+Ctrl+S', compound='left', image=save_as_file_icon, command=save_as)
file_menu.add_separator()
file_menu.add_command(label='Exit', accelerator='Alt+F4', compound='left', image=exit_icon, command=exit_editor)
menu_bar.add_cascade(label='File', menu=file_menu)

##file menu items end

##edit menu-items will be added here
edit_menu = Menu(menu_bar, tearoff=0)
##menu items
edit_menu.add_command(label='Undo', accelerator='Ctrl+Z', compound='left', image=undo_icon, command=undo)  # image argument for icon
...
edit_menu.add_separator()
edit_menu.add_command(label='Find', accelerator='Ctrl+F', compound='left', underline=0, image=find_icon, command=find_text)
edit_menu.add_separator()
edit_menu.add_command(label='Select All', underline=7, accelerator='Ctrl+A', compound='left', command=select_all)
menu_bar.add_cascade(label='Edit', menu=edit_menu)
##edit menu items end

##View menu-items will be added here
...
help_menu.add_command(label='About', command=display_about_messagebox)
help_menu.add_command(label='Help', command=display_help_messaggebox)

menu_bar.add_cascade(label='Help', menu=help_menu)
##Help menu items end
root.config(menu=menu_bar)
##Adding menu in the widget End
...
for i in ('cut', 'copy', 'paste', 'undo', 'redo'):
    cmd = eval(i)
    popup_menu.add_command(label=i.title(), compound='left', command=cmd)
popup_menu.add_separator()
popup_menu.add_command(label='Select All', underline=7, command=select_all)
##Context menu or popup menu end
##Content portion + Scroll bar settings end
...
content_text.bind('<KeyPress-F1>', display_help_messaggebox)

content_text.bind('<Button-3>', show_popup_menu)
##binding shortcut keys to command end
##Current line will be highlight in different color
